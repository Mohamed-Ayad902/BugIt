...
/**
 * Helper to generate random images for mockups.
 */
...
val dummyBugs = listOf(
    Bug(
        ...
        remoteImageUrl = getImageUrl("1_remote"),
    ...
    Bug(
        ...
        remoteImageUrl = "", // Empty for pending/failed
    ...
    Bug(
        ...
        remoteImageUrl = getImageUrl("3_remote"),
    ...
    Bug(
        ...
        remoteImageUrl = getImageUrl("5_remote"),
        status = SyncStatus.COMPLETED
    ),
    Bug(
        id = "6",
    ...
    Bug(
        ...
        remoteImageUrl = getImageUrl("7_remote"),
        status = SyncStatus.COMPLETED
    ),
    Bug(
        id = "8",
    ...
    Bug(
        ...
        remoteImageUrl = getImageUrl("9_remote"),
        status = SyncStatus.COMPLETED
    ),
    Bug(
        id = "10",
